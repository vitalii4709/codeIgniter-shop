                    ...
                    <form action="<?= route_to('admin.user.update', $user['id']); ?>" method="post">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="email" class="form-control <?= add_error_class($errors_data, 'email'); ?>" id="title" value="<?= $user['email'] ?>">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="name" class="form-control <?= add_error_class($errors_data, 'name'); ?>" id="name" value="<?= $user['name'] ?>">
                                <?= display_error($errors_data, 'name'); ?>
                            </div>

                            <div class="form-group col-md-6">
                                <label for="address">Адрес</label>
                                <input type="text" name="address" class="form-control <?= add_error_class($errors_data, 'address'); ?>" id="address" value="<?= $user['address'] ?>">
