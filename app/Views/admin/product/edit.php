        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="<?= route_to('admin.product.update', $product['id']); ?>" method="post">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="title" class="form-control <?= add_error_class($errors_data, 'title'); ?>" id="title" placeholder="Наименование товара" value="<?= $product['title'] ?>">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control <?= add_error_class($errors_data, 'category_id'); ?>" name="category_id" id="category_id">
                                    <?= view_cell('\App\Libraries\Category::getCategoriesList', ['category_id' => $product['category_id']]) ?>
                                </select>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="price" class="form-control <?= add_error_class($errors_data, 'price'); ?>" id="price" placeholder="Цена" value="<?= $product['price'] ?>">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                <div class="form-check">
                                    <input name="status" id="status" class="form-check-input" type="checkbox" <?= $product['status'] ? 'checked' : ''; ?>>
                                    <label for="status" class="form-check-label">Статус</label>
                                </div>

                                <div class="form-check">
                                    <input name="hit" id="hit" class="form-check-input" type="checkbox" <?= $product['hit'] ? 'checked' : ''; ?>>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="keywords" class="form-control <?= add_error_class($errors_data, 'keywords'); ?>" id="keywords" placeholder="Ключевые слова" value="<?= $product['keywords'] ?>">
                            </div>

                            <div class="form-group col-md-6">
                                <label for="description">Мета-описание</label>
                                <input type="text" name="description" class="form-control <?= add_error_class($errors_data, 'description'); ?>" id="description" placeholder="Мета-описание" value="<?= $product['description'] ?>">
                            </div>
                        </div>

                        <div class="form-row">
                            <div class="form-group col-md-12">
                                <label for="excerpt">Краткое описание товара</label>
                                <textarea name="excerpt" id="excerpt" class="form-control <?= add_error_class($errors_data, 'excerpt'); ?>"><?= $product['excerpt'] ?></textarea>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <textarea name="content" id="content" class="form-control editor"><?= $product['content'] ?></textarea>
                            </div>
                        </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div id="base-img-output" class="upload-images base-image">
                                            <div class="product-img-upload">
                                                ...
                                                <?php if ($product['img'] != env('NO_IMAGE')): ?>
